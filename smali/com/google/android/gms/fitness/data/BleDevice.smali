...
.field private final zzawd:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.method constructor <init>(ILjava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawc:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawd:Ljava/util/List;

    invoke-static {p5}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawe:Ljava/util/List;
...
.method private zza(Lcom/google/android/gms/fitness/data/BleDevice;)Z
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawc:Ljava/lang/String;

    iget-object v1, p1, Lcom/google/android/gms/fitness/data/BleDevice;->zzawc:Ljava/lang/String;
    ...
    iget-object v0, p1, Lcom/google/android/gms/fitness/data/BleDevice;->zzawd:Ljava/util/List;

    iget-object v1, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawd:Ljava/util/List;

    invoke-static {v0, v1}, Lcom/google/android/gms/internal/zznr;->zza(Ljava/util/List;Ljava/util/List;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawe:Ljava/util/List;

    iget-object v1, p1, Lcom/google/android/gms/fitness/data/BleDevice;->zzawe:Ljava/util/List;
...
.method public getSupportedProfiles()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawd:Ljava/util/List;
...
.method public hashCode()I
    ...
    iget-object v2, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawc:Ljava/lang/String;

    aput-object v2, v0, v1

    const/4 v1, 0x2

    iget-object v2, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawd:Ljava/util/List;

    aput-object v2, v0, v1

    const/4 v1, 0x3

    iget-object v2, p0, Lcom/google/android/gms/fitness/data/BleDevice;->zzawe:Ljava/util/List;
