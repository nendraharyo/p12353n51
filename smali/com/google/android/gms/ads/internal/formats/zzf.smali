...
.field private final zzyj:Landroid/support/v4/h/m;
...
.field private final zzyk:Landroid/support/v4/h/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/h/m",
            "<",
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Landroid/support/v4/h/m;Landroid/support/v4/h/m;Lcom/google/android/gms/ads/internal/formats/zza;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyj:Landroid/support/v4/h/m;

    iput-object p3, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyk:Landroid/support/v4/h/m;
...
.method public getAvailableAssetNames()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyj:Landroid/support/v4/h/m;

    invoke-virtual {v0}, Landroid/support/v4/h/m;->size()I

    move-result v0

    iget-object v1, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyk:Landroid/support/v4/h/m;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/h/m;->keyAt(I)Ljava/lang/Object;
    ...
    :cond_0
    :goto_1
    iget-object v0, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyk:Landroid/support/v4/h/m;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/h/m;->keyAt(I)Ljava/lang/Object;
