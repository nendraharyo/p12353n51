...
.method private static zzc(Lcom/google/android/gms/common/data/DataHolder;)V
    ...
    :cond_0
    :try_start_1
    invoke-static {v0}, Lcom/google/android/gms/internal/zznn;->zzf(Lcom/google/android/gms/common/data/DataHolder;)Landroid/support/v4/h/f;
    ...
    invoke-virtual {v3, v6, v7}, Landroid/support/v4/h/f;->a(J)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$zza;->zztA()Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
...
.method static synthetic zze(Lcom/google/android/gms/common/data/DataHolder;)V
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/zznn;->zzd(Lcom/google/android/gms/common/data/DataHolder;)V

    return-void
.end method

.method private static zzf(Lcom/google/android/gms/common/data/DataHolder;)Landroid/support/v4/h/f;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v6, Landroid/support/v4/h/f;

    invoke-direct {v6}, Landroid/support/v4/h/f;-><init>()V
    ...
    invoke-virtual {p0, v1}, Lcom/google/android/gms/common/data/DataHolder;->zzbH(I)I
    ...
    invoke-direct {v11, v12, v0}, Lcom/google/android/gms/drive/metadata/internal/CustomProperty;-><init>(Lcom/google/android/gms/drive/metadata/CustomPropertyKey;Ljava/lang/String;)V

    invoke-virtual {v6, v8, v9}, Landroid/support/v4/h/f;->a(J)Ljava/lang/Object;
    ...
    invoke-virtual {v6, v8, v9, v0}, Landroid/support/v4/h/f;->b(JLjava/lang/Object;)V

    :cond_0
    invoke-virtual {v0, v11}, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$zza;->zza(Lcom/google/android/gms/drive/metadata/internal/CustomProperty;)Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties$zza;
...
.method protected synthetic zzc(Lcom/google/android/gms/common/data/DataHolder;II)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/gms/internal/zznn;->zzl(Lcom/google/android/gms/common/data/DataHolder;II)Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
...
.method protected zzl(Lcom/google/android/gms/common/data/DataHolder;II)Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
    ...
    invoke-static {p1}, Lcom/google/android/gms/internal/zznn;->zzc(Lcom/google/android/gms/common/data/DataHolder;)V
    ...
    sget-object v0, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;->zzasK:Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;

    :goto_0
    return-object v0

    :cond_1
    sget-object v1, Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;->zzasK:Lcom/google/android/gms/drive/metadata/internal/AppVisibleCustomProperties;
