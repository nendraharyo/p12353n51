...
.method private static zza(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    :cond_5
    new-instance v4, Landroid/support/v4/app/w$c;

    invoke-direct {v4, p1}, Landroid/support/v4/app/w$c;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/w$c;->a(I)Landroid/support/v4/app/w$c;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroid/support/v4/app/w$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/w$c;
    ...
    invoke-virtual {v1, v4, v5}, Landroid/support/v4/app/w$c;->a(J)Landroid/support/v4/app/w$c;

    move-result-object v1

    invoke-virtual {v1, v6}, Landroid/support/v4/app/w$c;->b(Z)Landroid/support/v4/app/w$c;

    move-result-object v1

    invoke-virtual {v1, v3}, Landroid/support/v4/app/w$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/w$c;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroid/support/v4/app/w$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/w$c;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v4/app/w$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/w$c;
...
.method public static zza(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;Ljava/lang/String;Landroid/app/Dialog;)V
    ...
    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/SupportErrorDialogFragment;->show(Landroid/support/v4/app/m;Ljava/lang/String;)V
