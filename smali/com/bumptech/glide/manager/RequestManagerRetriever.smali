...
.field private final tempViewToFragment:Landroid/support/v4/h/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final tempViewToSupportFragment:Landroid/support/v4/h/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/h/a",
            "<",
...
.method public constructor <init>(Lcom/bumptech/glide/manager/RequestManagerRetriever$RequestManagerFactory;)V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->tempViewToSupportFragment:Landroid/support/v4/h/a;

    new-instance v0, Landroid/support/v4/h/a;

    invoke-direct {v0}, Landroid/support/v4/h/a;-><init>()V

    iput-object v0, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->tempViewToFragment:Landroid/support/v4/h/a;
...
.method private findAllFragmentsWithViews(Landroid/app/FragmentManager;Landroid/support/v4/h/a;)V
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0x1a
    .end annotation
    ...
    invoke-direct {p0, v0, p2}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->findAllFragmentsWithViews(Landroid/app/FragmentManager;Landroid/support/v4/h/a;)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, p1, p2}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->findAllFragmentsWithViewsPreO(Landroid/app/FragmentManager;Landroid/support/v4/h/a;)V

    :cond_2
    return-void
.end method

.method private findAllFragmentsWithViewsPreO(Landroid/app/FragmentManager;Landroid/support/v4/h/a;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    iget-object v2, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->tempBundle:Landroid/os/Bundle;
...
.method private findFragment(Landroid/view/View;Landroid/app/Activity;)Landroid/app/Fragment;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->tempViewToFragment:Landroid/support/v4/h/a;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->tempViewToFragment:Landroid/support/v4/h/a;

    invoke-direct {p0, v0, v1}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->findAllFragmentsWithViews(Landroid/app/FragmentManager;Landroid/support/v4/h/a;)V
...
.method private findSupportFragment(Landroid/view/View;Landroid/support/v4/app/i;)Landroid/support/v4/app/Fragment;
    .locals 3

    iget-object v0, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->tempViewToSupportFragment:Landroid/support/v4/h/a;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->tempViewToSupportFragment:Landroid/support/v4/h/a;
...
.method private fragmentGet(Landroid/content/Context;Landroid/app/FragmentManager;Landroid/app/Fragment;Z)Lcom/bumptech/glide/RequestManager;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/manager/RequestManagerRetriever;->factory:Lcom/bumptech/glide/manager/RequestManagerRetriever$RequestManagerFactory;
    ...
    invoke-interface {v2, v0, v3, v4, p1}, Lcom/bumptech/glide/manager/RequestManagerRetriever$RequestManagerFactory;->build(Lcom/bumptech/glide/Glide;Lcom/bumptech/glide/manager/Lifecycle;Lcom/bumptech/glide/manager/RequestManagerTreeNode;Landroid/content/Context;)Lcom/bumptech/glide/RequestManager;
...
.method private getSupportRequestManagerFragment(Landroid/support/v4/app/m;Landroid/support/v4/app/Fragment;Z)Lcom/bumptech/glide/manager/SupportRequestManagerFragment;
    .locals 3
...
.method private supportFragmentGet(Landroid/content/Context;Landroid/support/v4/app/m;Landroid/support/v4/app/Fragment;Z)Lcom/bumptech/glide/RequestManager;
    .locals 5

    invoke-direct {p0, p2, p3, p4}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->getSupportRequestManagerFragment(Landroid/support/v4/app/m;Landroid/support/v4/app/Fragment;Z)Lcom/bumptech/glide/manager/SupportRequestManagerFragment;
...
.method public get(Landroid/content/Context;)Lcom/bumptech/glide/RequestManager;
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->get(Landroid/support/v4/app/i;)Lcom/bumptech/glide/RequestManager;
...
.method public get(Landroid/support/v4/app/Fragment;)Lcom/bumptech/glide/RequestManager;
    ...
    invoke-direct {p0, v1, v0, p1, v2}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->supportFragmentGet(Landroid/content/Context;Landroid/support/v4/app/m;Landroid/support/v4/app/Fragment;Z)Lcom/bumptech/glide/RequestManager;
...
.method public get(Landroid/support/v4/app/i;)Lcom/bumptech/glide/RequestManager;
    .locals 3
    ...
    invoke-direct {p0, p1, v0, v1, v2}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->supportFragmentGet(Landroid/content/Context;Landroid/support/v4/app/m;Landroid/support/v4/app/Fragment;Z)Lcom/bumptech/glide/RequestManager;
...
.method public get(Landroid/view/View;)Lcom/bumptech/glide/RequestManager;
    ...
    :cond_1
    instance-of v0, v1, Landroid/support/v4/app/i;
    ...
    invoke-direct {p0, p1, v0}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->findSupportFragment(Landroid/view/View;Landroid/support/v4/app/i;)Landroid/support/v4/app/Fragment;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v0}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->get(Landroid/support/v4/app/Fragment;)Lcom/bumptech/glide/RequestManager;
    ...
    :cond_4
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->get(Landroid/app/Fragment;)Lcom/bumptech/glide/RequestManager;
...
.method getSupportRequestManagerFragment(Landroid/support/v4/app/i;)Lcom/bumptech/glide/manager/SupportRequestManagerFragment;
    .locals 3
    ...
    invoke-direct {p0, v0, v1, v2}, Lcom/bumptech/glide/manager/RequestManagerRetriever;->getSupportRequestManagerFragment(Landroid/support/v4/app/m;Landroid/support/v4/app/Fragment;Z)Lcom/bumptech/glide/manager/SupportRequestManagerFragment;
