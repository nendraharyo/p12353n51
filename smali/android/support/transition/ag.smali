...
# interfaces
.implements Landroid/support/transition/ai;
...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    sget-boolean v0, Landroid/support/transition/ag;->e:Z
    ...
    sput-object v0, Landroid/support/transition/ag;->d:Ljava/lang/reflect/Method;

    sget-object v0, Landroid/support/transition/ag;->d:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v3, Landroid/support/transition/ag;->e:Z
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/transition/ae;
    ...
    invoke-static {p1}, Landroid/support/transition/ac;->a(Landroid/view/ViewGroup;)Landroid/support/transition/ac;
...
.method public a(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v1, Landroid/support/transition/ag;->a:Landroid/animation/LayoutTransition;

    if-nez v1, :cond_0

    new-instance v1, Landroid/support/transition/ag$1;

    invoke-direct {v1, p0}, Landroid/support/transition/ag$1;-><init>(Landroid/support/transition/ag;)V

    sput-object v1, Landroid/support/transition/ag;->a:Landroid/animation/LayoutTransition;
    ...
    invoke-static {v0}, Landroid/support/transition/ag;->a(Landroid/animation/LayoutTransition;)V
    ...
    :cond_2
    sget-object v0, Landroid/support/transition/ag;->a:Landroid/animation/LayoutTransition;
    ...
    sget-boolean v1, Landroid/support/transition/ag;->c:Z
    ...
    sput-object v1, Landroid/support/transition/ag;->b:Ljava/lang/reflect/Field;

    sget-object v1, Landroid/support/transition/ag;->b:Ljava/lang/reflect/Field;
    ...
    :goto_1
    sput-boolean v4, Landroid/support/transition/ag;->c:Z
