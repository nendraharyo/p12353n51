...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/f/b;->a:Landroid/support/v4/h/g;
    ...
    sput-object v0, Landroid/support/v4/f/b;->d:Landroid/support/v4/h/m;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/f/a;Landroid/support/v4/a/a/b$a;Landroid/os/Handler;ZII)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroid/support/v4/f/b;->a:Landroid/support/v4/h/g;

    invoke-virtual {v0, v3}, Landroid/support/v4/h/g;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/a/a/b$a;->onFontRetrieved(Landroid/graphics/Typeface;)V
    ...
    invoke-virtual {p2, v1, p3}, Landroid/support/v4/a/a/b$a;->callbackSuccessAsync(Landroid/graphics/Typeface;Landroid/os/Handler;)V
    ...
    invoke-virtual {p2, v1, p3}, Landroid/support/v4/a/a/b$a;->callbackFailAsync(ILandroid/os/Handler;)V
    ...
    :try_start_1
    sget-object v0, Landroid/support/v4/f/b;->d:Landroid/support/v4/h/m;

    invoke-virtual {v0, v3}, Landroid/support/v4/h/m;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/h/m;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p2, p3}, Landroid/support/v4/f/b$2;-><init>(Landroid/support/v4/a/a/b$a;Landroid/os/Handler;)V
    ...
    sget-object v1, Landroid/support/v4/f/b;->d:Landroid/support/v4/h/m;

    invoke-virtual {v1, v3, v0}, Landroid/support/v4/h/m;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static a(Landroid/support/v4/f/a;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    invoke-static {p1, v0}, Landroid/support/v4/a/a/a;->a(Landroid/content/res/Resources;I)Ljava/util/List;
...
.method private static b(Landroid/content/Context;Landroid/support/v4/f/a;I)Landroid/support/v4/f/b$c;
    ...
    invoke-static {p0, v3, v1, p2}, Landroid/support/v4/b/c;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
