...
.method private a(Landroid/support/v4/a/a/a$b;I)Landroid/support/v4/a/a/a$c;
    ...
    new-instance v1, Landroid/support/v4/b/g$2;

    invoke-direct {v1, p0}, Landroid/support/v4/b/g$2;-><init>(Landroid/support/v4/b/g;)V

    invoke-static {v0, p2, v1}, Landroid/support/v4/b/g;->a([Ljava/lang/Object;ILandroid/support/v4/b/g$a;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/support/v4/a/a/a$c;
...
.method private static a([Ljava/lang/Object;ILandroid/support/v4/b/g$a;)Ljava/lang/Object;
    ...
    invoke-interface {p2, v6}, Landroid/support/v4/b/g$a;->b(Ljava/lang/Object;)I
    ...
    invoke-interface {p2, v6}, Landroid/support/v4/b/g$a;->a(Ljava/lang/Object;)Z
...
.method public a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    :try_start_0
    invoke-static {v1, p2, p3}, Landroid/support/v4/b/h;->a(Ljava/io/File;Landroid/content/res/Resources;I)Z
    :try_end_0
...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/f/b$b;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    invoke-virtual {p0, p3, p4}, Landroid/support/v4/b/g;->a([Landroid/support/v4/f/b$b;I)Landroid/support/v4/f/b$b;
    ...
    :try_start_1
    invoke-virtual {p0, p1, v1}, Landroid/support/v4/b/g;->a(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    :try_end_1
...
.method public a(Landroid/content/Context;Landroid/support/v4/a/a/a$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    :cond_0
    invoke-virtual {v0}, Landroid/support/v4/a/a/a$c;->d()I
    ...
    invoke-static {p1, p3, v1, v0, p4}, Landroid/support/v4/b/c;->a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
...
.method protected a(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
    ...
    :cond_0
    :try_start_0
    invoke-static {v1, p2}, Landroid/support/v4/b/h;->a(Ljava/io/File;Ljava/io/InputStream;)Z
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
